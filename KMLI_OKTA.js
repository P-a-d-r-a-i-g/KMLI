...
// @downloadURL https://raw.githubusercontent.com/P-a-d-r-a-i-g/KMLI/main/KMLI_OKTA.js
// @updateURL https://raw.githubusercontent.com/P-a-d-r-a-i-g/KMLI/main/KMLI_OKTA.js
// ==/UserScript==
...
(function () {
    ...
    function keepMeLoggedIn() {
        //$.ajax({ dataType: "text", type: "GET", cache: !1, url: "/session/extend", success: function (e) {} });
      var xhr = new XMLHttpRequest();
        xhr.open("GET", "/session/extend", true);
